...
Usage (from repo or any cwd):
    ...
    python sync_extension.py --dest "C:/path/to/pw45/pw45/CastInterface"
...
def _default_src_root() -> Path:
    return Path(__file__).resolve().parent / "CastInterface"
...
def main() -> int:
    ...
    parser.add_argument(
        "--src",
        type=Path,
        help="CastInterface source root (default: <repo>/CastInterface)",
    )
